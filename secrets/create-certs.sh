...
# Generate CA key
openssl req -new -x509 -keyout my-ca.key -out my-ca.crt -days 365 -subj '/CN=ca1.test.showmeyourcode/OU=TEST/O=showmeyourcode/L=London/S=LDN/C=UK' -passin pass:my-test-password -passout pass:my-test-password
...
do
	...
	keytool -genkey -noprompt \
				 -alias $i \
				 -dname "CN=$i.showmeyourcode.test, OU=TEST, O=showmeyourcode, L=London, S=LDN, C=UK" \

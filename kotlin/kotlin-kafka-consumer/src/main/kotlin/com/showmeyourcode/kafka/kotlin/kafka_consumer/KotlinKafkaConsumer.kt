...
class KotlinKafkaConsumer {
    companion object {
        ...
        private fun createConsumer(): Consumer<String, String> {
            ...
            properties[ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG] = KotlinKafkaProperties.BOOTSTRAP_SERVERS
            ...
            properties[ConsumerConfig.GROUP_ID_CONFIG] = KotlinKafkaProperties.CONSUMER_GROUP_ID
        ...
        fun runConsumer() {
            ...
            topics.add(KotlinKafkaProperties.TOPIC)
